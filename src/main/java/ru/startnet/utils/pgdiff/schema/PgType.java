...
import ru.startnet.utils.pgdiff.PgDiffUtils;
...
public class PgType {
    ...
    public boolean containsEnumValue(final String newValue) {
      return enumValues.parallelStream().anyMatch(value -> value.contentEquals(newValue));
    }
}