...
import ru.startnet.utils.pgdiff.schema.PgType;
...
public class PgDiffTypes {
    ...
    /*
     * if (newType.getIsEnum()) { for (final String newEnumkValue :
     * newType.getEnumValue()) { if (oldType.containsEnumValue(newEnumkValue)) {
     * 
     * }
     * 
     * } return; }
